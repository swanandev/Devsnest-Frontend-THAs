export const fetchUsersAPI = async (pageCount = 0, userCount = 15) => {
  let data = await fetch(
    `https://dummyapi.io/data/v1/user?page=${pageCount}&limit=${userCount}`,
    {
      headers: { "app-id": "61293d99eaba4b8c6e31f267" },
    }
  );
  let res = data.json();
  return res;
...
export const fetchPostsAPI = async (pageCount = 0, postCount = 20) => {
  let data = await fetch(
    `https://dummyapi.io/data/v1/post?page=${pageCount}&limit=${postCount}`,
    {
      headers: { "app-id": "61293d99eaba4b8c6e31f267" },
    }
  );
...
export const fetchCommentsAPI = async (
  ...
  let data = await fetch(`https://dummyapi.io/data/v1/post/${postId}/comment`, {
    headers: { "app-id": "61293d99eaba4b8c6e31f267" },
  });
  let res = data.json();
  return res;
...
export const genUserName = (fName: string, lName: string) =>
  `${fName.toLowerCase()}_${lName[0].toLowerCase()}`;
